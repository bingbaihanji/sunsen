...
public class LifecycleStateMachine {
    ...
    static {
        ...
        map.put(PluginState.RESOLVED, EnumSet.of(PluginState.LOADED, PluginState.FAILED));
        map.put(PluginState.LOADED, EnumSet.of(PluginState.STARTING, PluginState.UNLOADED, PluginState.FAILED));
        map.put(PluginState.STARTING, EnumSet.of(PluginState.ACTIVE, PluginState.FAILED));
        map.put(PluginState.ACTIVE, EnumSet.of(PluginState.STOPPING, PluginState.FAILED));
        map.put(PluginState.STOPPING, EnumSet.of(PluginState.STOPPED, PluginState.FAILED));
